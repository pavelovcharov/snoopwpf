...
namespace Snoop {
    public class ScreenCaptureHelper {
        public static BitmapSource CaptureMonitor(Screen monitor, out Rect bounds, out double scaleX, out double scaleY, out double scaleIfPrimaryX, out double scaleIfPrimaryY) {
            ...
            var bs = Imaging.CreateBitmapSourceFromHBitmap(dibSection, IntPtr.Zero, sourceRect, BitmapSizeOptions.FromEmptyOptions());
//            bs.Freeze();
            FormatConvertedBitmap formatConvertedBitmap = new FormatConvertedBitmap(bs, PixelFormats.Gray32Float, (BitmapPalette) null, 1.0);
